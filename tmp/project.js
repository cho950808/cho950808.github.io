...
const project_data = [
    {
        ...
        project_name: '착귀갑사(모바일 게임) - 운영툴, 통계툴',
        project_period: '2023. 6 ~ 2023. 7',
        project_desc: '착귀갑사(7월 말 오픈 예정) 게임 내 운영, 통계툴 어드민',
        project_thum: StarLightThum,
        project_image: [],
        project_info: [
            {
                info: '전체적인 프론트 영역 프로젝트 설계 및 개발 환경 구축 (QA, Dev, Prod)',
            },
            {
                info: '가이드 작성 및 문서화',
            },
