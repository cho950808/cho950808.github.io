  ...
  return (
    <div id="skills" className="w-full mt-[200px] p-2">
      <div className="max-w-[1240px] mx-auto flex flex-col justify-center h-full ">
        ...
        <h2 className="py-4 mt-10">Back-End</h2>
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          <SkillsItem urlImg={Html} framework="html" />
          <SkillsItem urlImg={Tailwind} framework="tailwind" />
        ...
        <h2 className="py-4 mt-10">Version Control</h2>
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          <SkillsItem urlImg={Github} framework="github" />
        </div>

        <h2 className="py-4 mt-10">Communication</h2>
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          <SkillsItem urlImg={Github} framework="Zeplin" />
          <SkillsItem urlImg={Github} framework="figma" />
        </div>
      </div>
    </div>
  );
